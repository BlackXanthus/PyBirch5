...
# Form implementation generated from reading ui file 'pyqt5_Properties.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.input_Ident = QtWidgets.QLineEdit(self.IRCServer)
        self.input_Ident.setObjectName("input_Ident")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.input_Ident)
        self.input_RealName = QtWidgets.QLineEdit(self.IRCServer)
        self.input_RealName.setObjectName("input_RealName")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.input_RealName)
        ...
        self.input_FontSize = QtWidgets.QLineEdit(self.Font)
        self.input_FontSize.setObjectName("input_FontSize")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.input_FontSize)
