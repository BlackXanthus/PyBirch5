...
class Ui_BirchSubWindow(object):
    def setupUi(self, BirchSubWindow):
        BirchSubWindow.setObjectName("BirchSubWindow")
        ...
        self.editor_Window.setDocumentTitle("")
        ...
        self.list_NickList.setObjectName("list_NickList")
    ...
    def retranslateUi(self, BirchSubWindow):
        ...
        BirchSubWindow.setWindowTitle(_translate("BirchSubWindow", "Form"))
        self.label_ChanName.setText(_translate("BirchSubWindow", "(None)"))
